...
local ____exports = {}
local VehicleHealth, VehicleSeats, Ped
local ____natives = require("_types.natives")
local ENTITY = ____natives.ENTITY
local VEHICLE = ____natives.VEHICLE
local TASK = ____natives.TASK
local STREAMING = ____natives.STREAMING
local ____stand = require("_types.stand")
local entities = ____stand.entities
local util = ____stand.util
...
function Vehicle.prototype.____constructor(self, handle, pos, heading)
    ...
    self.health = __TS__New(VehicleHealth, self)
    self.seats = __TS__New(VehicleSeats, self)
end
__TS__SetDescriptor(
    Vehicle.prototype,
    "Health",
